...
public class ControlSysListActivity extends ComListActivity<ComSys> {
            ...
            public void onUpdate(BaseAdapterHelper helper, final ComSys item, int position) {
                ...
                helper.setOnLongClickListener(R.id.ll_item, new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View view) {
                        ...
                        mDig = new SweetAlertDialog(ControlSysListActivity.this, SweetAlertDialog.WARNING_TYPE);
    ...
    private void delete(final ComSys item) {
        ...
        // 采集设备添加
        OkHttpUtils.post().url(myTool.getServAdd() + "farmControlSystem/deleteControlSystem")
                .params(map)
                .build()
                .execute(new StringCallback() {
                    @Override
